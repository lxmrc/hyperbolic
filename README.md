...
I only have the basic functionality in place: an in-browser code editor which can connect to a container on the server where the code is run and the output then returned to the browser.
